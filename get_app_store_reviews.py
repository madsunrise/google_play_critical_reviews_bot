...
def get_and_collect_reviews(review_id, no_of_pages, country_code):
    ...
    for page in range(no_of_pages):
        ...
        reviews_response = get_reviews(review_id, page + 1, country_code)
...
def get_reviews(review_id, page_no, country_code):
    """
    ...
    url = f'https://itunes.apple.com/{country_code}/rss/customerreviews/page={page_no}/id={review_id}/sortBy=mostRecent/json'
